...
namespace MobileKidsIdApp.ViewModels
{
    public class StaticContent : BindableObject
    {
        ...
        //    // TODO : Read static HTML content into HtmlSource object here.
        //    html = "<p>This is a test.</p>";
        //    HtmlSource.Html = String.Format(
        //        @"<html><head><link rel='stylesheet' type='text/css' src='default.css'></head><body>{0}</body></html>",
        //        html);
        //}
